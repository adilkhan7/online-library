...
<div class="news">
  ...
  <div class="sortirovka">
    ...
    <form method="POST">
      ...
      <select name="rank">
        <option value="base">Вы можете сортировать книги</option>
  ...
  <div class="filter">
    <div class="mainn">
      <form method="POST">
        ...
        <?php
          $stmtop = $pdo->query("SELECT * FROM books ;");
        ...
        <span>Статус:</span>
        <select name="status">
          <option value="all">Все статусы книг</option>
          <?php
        ...
        <span>Цена:</span>
        <select name="cost">
          <option value="all">Все ценовые категории</option>
          <option value="six">6000тг - </option>
          <option value="four">4000тг - 5999тг</option>
          <option value="two">2000тг - 3999тг</option>
          <option value="one"> - 1999тг </option>
        </select>
